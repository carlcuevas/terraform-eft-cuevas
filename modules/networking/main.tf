...
#   - Security Group con reglas de ingress/egress
#
...
resource "aws_security_group" "main" {
  ...
  # Regla HTTP - acceso público permitido
  ingress {
    description = "HTTP"
    from_port   = 80
    to_port     = 80
  ...
  # Regla HTTPS - acceso público permitido
  ingress {
    description = "HTTPS"
    from_port   = 443
    to_port     = 443
  ...
  # Regla SSH - restringida a IP específica (política OPA IL2.1)
  ingress {
