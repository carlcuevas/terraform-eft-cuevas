...
# =============================================================================
# Política: Restringir tipo de instancia EC2 a t2.micro
# -----------------------------------------------------------------------------
# Objetivo:
#   Controlar costos y cumplir con los requerimientos del proyecto limitando
#   la creación de instancias EC2 exclusivamente al tipo t2.micro.
#
...
deny contains msg if {
    ...
    msg := sprintf(
        "VIOLACION DE POLÍTICA [IL2.1]: La instancia '%s' usa tipo '%s'. Solo se permite t2.micro.",
